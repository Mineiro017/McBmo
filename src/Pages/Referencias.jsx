    ...
    return(
        <div>
            ...
            <div>
                ...
                <p className="text-dark-green">A proposta do nosso TCC surgiu da observação de um problema real e urgente: a dificuldade de comunicação entre psicólogos e pacientes com transtornos mentais ou deficiências cognitivas, como autismo, fobia social, depressão, ansiedade e dificuldades de expressão verbal. Muitos desses pacientes não conseguem relatar o que sentem de forma clara, o que compromete o diagnóstico, o acompanhamento e o sucesso do tratamento.
